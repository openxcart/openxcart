<?php
class AppModuleAffiliate extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/affiliate.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/affiliate.html', $data);
		} else {
			return $this->load->view('default/template/module/affiliate.html', $data);
		}
	}
}