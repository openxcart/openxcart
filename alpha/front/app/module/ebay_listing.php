<?php
class AppModuleEbayListing extends App {
	public function index() {
		if ($this->config->get('ebay_status') == 1) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/ebay.html')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/ebay.html', $data);
			} else {
				return $this->load->view('default/template/module/ebay.html', $data);
			}
		}
	}
}