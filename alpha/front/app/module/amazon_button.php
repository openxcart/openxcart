<?php
class AppModuleAmazonButton extends App {
	public function index($setting) {
		...
		if ($status) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/amazon_button.html')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/amazon_button.html', $data);
			} else {
				return $this->load->view('default/template/module/amazon_button.html', $data);
			}
		}
	}
}