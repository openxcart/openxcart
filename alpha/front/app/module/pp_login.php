<?php
class AppModulePPLogin extends App {
	private $error = array();
	...
	public function index() {
		if (!$this->customer->isLogged()) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/pp_login.html')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/pp_login.html', $data);
			} else {
				return $this->load->view('default/template/module/pp_login.html', $data);
			}
		}
	}
