<?php
class AppAccountRecurring extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/recurring_list.html')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/account/recurring_list.html', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/account/recurring_list.html', $data));
		}
	}
	...
	public function info() {
		...
		if ($recurring) {
			...
			$data['buttons'] = $this->load->app('payment/' . $recurring['payment_code'] . '/recurringButtons');
			$data['column_left'] = $this->load->app('common/column_left');
			$data['column_right'] = $this->load->app('common/column_right');
			$data['content_top'] = $this->load->app('common/content_top');
			$data['content_bottom'] = $this->load->app('common/content_bottom');
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/recurring_info.html')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/account/recurring_info.html', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/account/recurring_info.html', $data));
			}
		} else {
