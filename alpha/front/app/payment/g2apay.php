<?php
class AppPaymentG2APay extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/g2apay.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/g2apay.html', $data);
		} else {
			return $this->load->view('default/template/payment/g2apay.html', $data);
		}
	}
