<?php
class AppPaymentRealexRemote extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/realex_remote.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/realex_remote.html', $data);
		} else {
			return $this->load->view('default/template/payment/realex_remote.html', $data);
		}
	}
