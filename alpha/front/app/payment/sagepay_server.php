<?php
class AppPaymentSagepayServer extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/sagepay_server.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/sagepay_server.html', $data);
		} else {
			return $this->load->view('default/template/payment/sagepay_server.html', $data);
		}
	}
