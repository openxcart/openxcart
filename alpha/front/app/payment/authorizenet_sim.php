<?php
class AppPaymentAuthorizeNetSim extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/authorizenet_sim.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/authorizenet_sim.html', $data);
		} else {
			return $this->load->view('default/template/payment/authorizenet_sim.html', $data);
		}
	}
