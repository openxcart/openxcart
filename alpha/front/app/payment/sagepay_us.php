<?php
class AppPaymentSagepayUS extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/sagepay_us.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/sagepay_us.html', $data);
		} else {
			return $this->load->view('default/template/payment/sagepay_us.html', $data);
		}
	}
