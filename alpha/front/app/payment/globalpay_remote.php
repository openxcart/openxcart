<?php
class AppPaymentGlobalpayRemote extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/globalpay_remote.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/globalpay_remote.html', $data);
		} else {
			return $this->load->view('default/template/payment/globalpay_remote.html', $data);
		}
	}
