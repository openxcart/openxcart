<?php
class AppPaymentPerpetualPayments extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/perpetual_payments.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/perpetual_payments.html', $data);
		} else {
			return $this->load->view('default/template/payment/perpetual_payments.html', $data);
		}
	}
