<?php
class AppPaymentSecureTradingPp extends App {
	public function index() {
		...
		if ($order_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/securetrading_pp.html')) {
				return $this->load->view($this->config->get('config_template') . '/template/payment/securetrading_pp.html', $data);
			} else {
				return $this->load->view('default/template/payment/securetrading_pp.html', $data);
			}
		}
	}
