<?php
class AppPaymentPPProIframe extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_pro_iframe.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/pp_pro_iframe.html', $data);
		} else {
			return $this->load->view('default/template/payment/pp_pro_iframe.html', $data);
		}
	}
	...
	public function create() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_pro_iframe_body.html')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/pp_pro_iframe_body.html', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/pp_pro_iframe_body.html', $data));
		}
	}
