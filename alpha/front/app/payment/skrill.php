<?php
class AppPaymentSkrill extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/skrill.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/skrill.html', $data);
		} else {
			return $this->load->view('default/template/payment/skrill.html', $data);
		}
	}
