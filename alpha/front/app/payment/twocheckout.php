<?php
class AppPaymentTwoCheckout extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/twocheckout.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/twocheckout.html', $data);
		} else {
			return $this->load->view('default/template/payment/twocheckout.html', $data);
		}
	}
