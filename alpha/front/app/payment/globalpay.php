<?php
class AppPaymentGlobalpay extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/globalpay.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/globalpay.html', $data);
		} else {
			return $this->load->view('default/template/payment/globalpay.html', $data);
		}
	}
	...
	public function notify() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/globalpay_response.html')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/globalpay_response.html', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/globalpay_response.html', $data));
		}
	}
}