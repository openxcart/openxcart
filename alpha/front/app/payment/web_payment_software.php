<?php
class AppPaymentWebPaymentSoftware extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/web_payment_software.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/web_payment_software.html', $data);
		} else {
			return $this->load->view('default/template/payment/web_payment_software.html', $data);
		}
	}
	...
	public function send() {
		...
		//If successful log transaction in opencart core
