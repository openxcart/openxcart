<?php
class AppPaymentPaymate extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paymate.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/paymate.html', $data);
		} else {
			return $this->load->view('default/template/payment/paymate.html', $data);
		}
	}
