<?php
class AppPaymentFirstdataRemote extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/firstdata_remote.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/firstdata_remote.html', $data);
		} else {
			return $this->load->view('default/template/payment/firstdata_remote.html', $data);
		}
	}
