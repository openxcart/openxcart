...
class AppPaymentWorldpay extends App {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/worldpay.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/worldpay.html', $data);
		} else {
			return $this->load->view('default/template/payment/worldpay.html', $data);
		}
	}
