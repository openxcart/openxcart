<?php
class AppPaymentPPPro extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_pro.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/pp_pro.html', $data);
		} else {
			return $this->load->view('default/template/payment/pp_pro.html', $data);
		}
	}
