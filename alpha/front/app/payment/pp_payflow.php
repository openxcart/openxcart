<?php
class AppPaymentPPPayflow extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_payflow.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/pp_payflow.html', $data);
		} else {
			return $this->load->view('default/template/payment/pp_payflow.html', $data);
		}
	}
