<?php
class AppPaymentPPExpress extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_express.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/pp_express.html', $data);
		} else {
			return $this->load->view('default/template/payment/pp_express.html', $data);
		}
	}
	...
	public function expressConfirm() {
		...
		$data['coupon'] = $this->load->app('module/coupon');
		$data['voucher'] = $this->load->app('module/voucher');
		$data['reward'] = $this->load->app('module/reward');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_express_confirm.html')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/pp_express_confirm.html', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/pp_express_confirm.html', $data));
		}
	}
	...
	public function checkoutReturn() {
		...
		if ($result['ACK'] == 'Success') {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/error/not_found.html')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/error/not_found.html'));
			} else {
				$this->response->setOutput($this->load->view('default/template/error/not_found.html'));
			}
		}
	}
	...
	public function recurringButtons() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/buttons.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/buttons.html', $data);
		} else {
			return $this->load->view('default/template/common/buttons.html', $data);
		}
	}
}
