<?php
class AppPaymentRealex extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/realex.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/realex.html', $data);
		} else {
			return $this->load->view('default/template/payment/realex.html', $data);
		}
	}
	...
	public function notify() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/realex_response.html')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/realex_response.html', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/realex_response.html', $data));
		}
	}
}