<?php
class AppPaymentBluePayRedirect extends App {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/bluepay_redirect.html')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/bluepay_redirect.html', $data);
		} else {
			return $this->load->view('default/template/payment/bluepay_redirect.html', $data);
		}
	}
