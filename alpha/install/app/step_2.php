...
class AppStep2 extends App {
	...
	public function index() {
		...
		$data['config_catalog'] = DIR_OPENXCART . 'config.php';
		$data['config_admin'] = DIR_OPENXCART . 'admin/config.php';

		$data['cache'] = DIR_CORE . 'cache';
		$data['logs'] = DIR_CORE . 'logs';
		$data['download'] = DIR_CORE . 'download';
		$data['upload'] = DIR_CORE . 'upload';
		$data['image'] = DIR_OPENXCART . 'image';
		$data['image_cache'] = DIR_OPENXCART . 'image/cache';
		$data['image_data'] = DIR_OPENXCART . 'image/catalog';
		$data['modification'] = DIR_CORE . 'modification';

		$data['back'] = $this->url->link('step_1');

		$data['footer'] = $this->load->app('footer');
		$data['header'] = $this->load->app('header');
