...
define('HTTP_OPENXCART', $protocol . $_SERVER['HTTP_HOST'] . rtrim(rtrim(dirname($_SERVER['SCRIPT_NAME']), 'install'), '/.\\') . '/');
...
if (file_exists('../config.php')) {
	if (filesize('../config.php') > 0) {
		...
		$lines = file(DIR_OPENXCART . 'config.php');
...
// Dispatch
$app->dispatch($action, new Action('not_found'));
