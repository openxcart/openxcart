<?php
class AppExtensionFraud extends App {
	private $error = array();
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->load->app('fraud/' . $this->request->get['extension'] . '/install');
	...
	public function uninstall() {
		...
		if ($this->validate()) {
			...
			$this->load->app('fraud/' . $this->request->get['extension'] . '/uninstall');
	...
	public function getList() {
		...
		foreach ($extensions as $key => $value) {
			if (!file_exists(DIR_APPLICATION . 'app/fraud/' . $value . '.php')) {
		...
		$files = glob(DIR_APPLICATION . 'app/fraud/*.php');
