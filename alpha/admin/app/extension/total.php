<?php
class AppExtensionTotal extends App {
	private $error = array();
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->load->app('total/' . $this->request->get['extension'] . '/install');
	...
	public function uninstall() {
		...
		if ($this->validate()) {
			...
			$this->load->app('total/' . $this->request->get['extension'] . '/uninstall');
	...
	public function getList() {
		...
		foreach ($extensions as $key => $value) {
			if (!file_exists(DIR_APPLICATION . 'app/total/' . $value . '.php')) {
		...
		$files = glob(DIR_APPLICATION . 'app/total/*.php');
