<?php
class AppExtensionShipping extends App {
	private $error = array();
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->load->app('shipping/' . $this->request->get['extension'] . '/install');
	...
	public function uninstall() {
		...
		if ($this->validate()) {
			...
			$this->load->app('shipping/' . $this->request->get['extension'] . '/uninstall');
	...
	public function getList() {
		...
		foreach ($extensions as $key => $value) {
			if (!file_exists(DIR_APPLICATION . 'app/shipping/' . $value . '.php')) {
		...
		$files = glob(DIR_APPLICATION . 'app/shipping/*.php');
