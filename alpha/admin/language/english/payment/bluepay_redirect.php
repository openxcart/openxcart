<?php
// Heading
$lang['heading_title']					= 'BluePay Redirect (Requires SSL)';

// Text
$lang['text_payment']					= 'Payment';
$lang['text_success']					= 'Success: You have modified BluePay Redirect account details!';
$lang['text_edit']                     = 'Edit BluePay Redirect (Requires SSL)';
$lang['text_bluepay_redirect']			= '<a href="http://www.bluepay.com/preferred-partner/opencart" target="_blank"><img src="view/image/payment/bluepay.jpg" alt="BluePay Redirect" title="BluePay Redirect" style="border: 1px solid #EEEEEE;" /></a>';
